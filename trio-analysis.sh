...
java -jar ${GATK} -T GenotypeGVCFs \
                  -R ${REF_GENOME} \
                  -o trio.vcf \ --variant HG02024.g.vcf \ --variant HG02025.g.vcf \ --variant HG02026.g.vcf
...
# Phase trios
# Command: gatk PhaseByTransmission # Recherche les variants improbables en se basant sur les liens de parenté.
...
java -jar ${GATK} -T GenotypeConcordance \ -R ${REF_GENOME} \ -o trio.report.file.txt \ -eval  trio.vcf \ -comp trio.phased.vcf
